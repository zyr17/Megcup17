...
# Your token here
CONTEST_TOKEN = '6ba062d2cacc80230797b339afd526910ff42c146959584e214da41841307b3d'
PRACTICE_TOKEN = 'd3b70314814ad412e485959641c24ff019625dfa933b79703208ccac2d260ab6'
...
if __name__ == '__main__':
	...
	parser.add_argument( '--groupnum', action='store',
			help='choose one group')
	...
	seqs=[]
	for seq_id in range(int(args.groupnum), int(args.groupnum) + 1):
